...
print(id(my_list), 'in memory')
my_list.pop()
print(id(my_list), 'after pop')
#id keyword
my_var1 = f"test 1 {10-9}" .capitalize()
print(id(my_var1))
my_var2 = "Test 1 1"
print(id(my_var2))
print(my_var1 is my_var2)  #nu sunt accelasi obiect (se uita dupa ID in memorie)
print(my_var1 == my_var2)  #valorile lor sunt egale (se uita la continut)
